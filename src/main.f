...
*     prior p(f) Dirichlet
*     et une param�trisation � la Falush (Genetics 2003)
...
************************************************************************
*     Mise � jour M-H du vecteur de d�rives g�n�tiques 
...
*     avec prior Poisson(lambda) tronqu�e :   0 < m < nppmax
...
*
*     Tirage de nu cellules parmi ncellpop cellules
*      version corrig�e de sample apres un bug 
*     trouv� en septembre 2005 � G�teborg
...
***********************************************************************
*
*     Naissance et mort de pop avec r�allocations 
*     (split/merge)
*     proposition de drift* selon prior
*     proposition de f* selon conditionelle compl�te 
*     dans les deux sens
*
...
************************************************************************
*     ajoute une pop 
*     dans  le tableau des d�rives selon le prior
*     et dans le tableau des frequences 
*     selon la conditionelle compl�te pour les deux nouveaux groupes
*     (sans modifier les tableaux en entr�e)
...
*     selon la conditionelle compl�te pour les deux nouveaux groupes
*     et une valeur 0.5d0 dans le tableau des d�rives 
*     (sans modifier les tableaux en entr�e)
...
*     sans modifier des tableaux en entr�e
